...
Rails.application.configure do
  ...
  ActionMailer::Base.smtp_settings = {
    ...
    :password => Rails.application.credentials[Rails.env.to_sym].dig(:sendgrid, :api_key), # This is the secret sendgrid API key which was issued during API key creation
